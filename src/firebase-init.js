...
*
* Called after DOM loaded. Initializes Firebase and FirebaseUI.
* Application specific details are in 'app.js'.
*/

// tbd. FirebaseUI stuff likely to leave to 'SignIn.vue'
